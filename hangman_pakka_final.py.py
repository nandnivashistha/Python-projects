...
print(blank_list)  
lives=7
while '_' in blank_list and lives>=1:
  guess=input("guess a letter:").lower()
  if guess in blank_list:
    print(f'you have already guessed the letter{guess}')
  for alphabet in range(len(converted_word)) :
    if converted_word[alphabet]==guess:
      blank_list[alphabet]=guess
  if guess not in blank_list:
    lives-=1
    print(f'{guess} is not in the word')  
  #print(blank_list)  
  final=''
  answer=final.join(blank_list)
  print(answer)
